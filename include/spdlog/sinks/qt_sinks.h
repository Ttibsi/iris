...
namespace spdlog {
    namespace sinks {
        ...
        // max_lines is the maximum number of lines that the sink will hold before removing the
        // oldest lines. By default, only ascii (latin1) is supported by this sink. Set is_utf8 to
        // true if utf8 support is needed.
        template <typename Mutex>
