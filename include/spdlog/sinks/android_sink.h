...
namespace spdlog {
    namespace sinks {
        ...
        /*
         * Android sink
         * (logging using __android_log_write or __android_log_buf_write
         * depending on the specified BufferID)
         */
        ...
        class android_sink final : public base_sink<Mutex> {
          ...
          protected:
            void sink_it_(const details::log_msg &msg) override {
                const android_LogPriority priority =
                    convert_to_android_(msg.level);
                memory_buf_t formatted;
                if (use_raw_msg_) {
                    details::fmt_helper::append_string_view(msg.payload,
                                                            formatted);
                } else {
                ...
                // See system/core/liblog/logger_write.c for explanation of
                // return value
          ...
          private:
            ...
            // __android_log_buf_write, if user explicitly provides a
            // non-default log buffer. Otherwise, when using the default log
            // buffer, always log via __android_log_write.
