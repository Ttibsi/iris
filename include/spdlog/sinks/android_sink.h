...
namespace spdlog {
    namespace sinks {
        ...
        class android_sink final : public base_sink<Mutex> {
           ...
           private:
            // There might be liblog versions used, that do not support __android_log_buf_write. So
            // we only compile and link against
            // __android_log_buf_write, if user explicitly provides a non-default log buffer.
