...
namespace spdlog {
    namespace sinks {
         ...
         * hour, minute);" auto logger =
         * spdlog::daily_logger_format_mt("loggername, "myapp-%Y-%m-%d:%X.log",
         * hour,  minute)"
         *
         */
         ...
         * Note that old log files from previous executions will not be deleted
         * by this class, rotation and deletion is only applied while the
         * program is running.
         */
        ...
        class daily_file_sink final : public base_sink<Mutex> {
          public:
            ...
            daily_file_sink(filename_t base_filename, int rotation_hour,
                ...
                : base_filename_(std::move(base_filename)),
                  rotation_h_(rotation_hour), rotation_m_(rotation_minute),
          ...
          private:
            void init_filenames_q_() {
                ...
                for (auto iter = filenames.rbegin(); iter != filenames.rend();
                     ++iter) {
        ...
        using daily_file_format_sink_st =
            daily_file_sink<details::null_mutex,
