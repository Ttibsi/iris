    ...
    namespace details {
        ...
        class a_formatter final : public flag_formatter {
           public:
            ...
            void format(const details::log_msg&, const std::tm& tm_time, memory_buf_t& dest)
                override {
    ...
    SPDLOG_INLINE void pattern_formatter::handle_flag_(char flag, details::padding_info padding) {
        ...
        switch (flag) {
            ...
            case ('i'):  // elapsed time since last log message in micros
                formatters_.push_back(
                    details::make_unique<
                        details::elapsed_formatter<Padder, std::chrono::microseconds>>(padding));
                break;

            case ('o'):  // elapsed time since last log message in millis
                formatters_.push_back(
                    details::make_unique<
                        details::elapsed_formatter<Padder, std::chrono::milliseconds>>(padding));
                break;
            ...
            default:  // Unknown flag appears as is
                ...
                // instead of truncating flag) spdlog::set_pattern("[%10!] %v") => "[      main]
