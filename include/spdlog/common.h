...
#define SPDLOG_BUF_TO_STRING(x) x
    ...
    // so have to repeat the condition from basic_format_string here, in
    // addition, fmt::basic_runtime<Char> is only convertible to
...
#define SPDLOG_SHORT_LEVEL_NAMES { "T", "D", "I", "W", "E", "C", "O" }
    ...
    struct source_loc {
        ...
        SPDLOG_CONSTEXPR source_loc(const char *filename_in, int line_in,
            ...
            : filename{ filename_in }, line{ line_in },
