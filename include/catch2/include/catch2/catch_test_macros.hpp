...
#define CATCH_SKIP(...)                                                                     \
    do {                                                                                    \
        INTERNAL_CATCH_MSG(                                                                 \
            "CATCH_SKIP", Catch::ResultWas::ExplicitSkip, Catch::ResultDisposition::Normal, \
            __VA_ARGS__);                                                                   \
        Catch::Detail::Unreachable();                                                       \
    } while (false)
...
#define FAIL(...)                                                                        \
    do {                                                                                 \
        INTERNAL_CATCH_MSG(                                                              \
            "FAIL", Catch::ResultWas::ExplicitFailure, Catch::ResultDisposition::Normal, \
            __VA_ARGS__);                                                                \
        Catch::Detail::Unreachable();                                                    \
    } while (false)
#define FAIL_CHECK(...)                                  \
...
#define SKIP(...)                                                                     \
    do {                                                                              \
        INTERNAL_CATCH_MSG(                                                           \
            "SKIP", Catch::ResultWas::ExplicitSkip, Catch::ResultDisposition::Normal, \
            __VA_ARGS__);                                                             \
        Catch::Detail::Unreachable();                                                 \
    } while (false)
