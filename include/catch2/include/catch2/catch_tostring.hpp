...
namespace Catch {
    ...
    namespace Detail {
        ...
        static constexpr bool IsStreamInsertable_v<
            T,
            decltype(void(std::declval<std::ostream&>() << std::declval<T>()))> = true;
    ...
    struct StringMaker {
        ...
        static std::enable_if_t<::Catch::Detail::IsStreamInsertable_v<Fake>, std::string> convert(
            const Fake& value) {
    ...
    namespace Detail {
        ...
        std::string stringify(const T& e) {
            CATCH_TRY {
                return ::Catch::StringMaker<std::remove_cv_t<std::remove_reference_t<T>>>::convert(
                    e);
            }
            CATCH_CATCH_ALL {
...
namespace Catch {
    ...
    struct StringMaker<
        R,
        std::enable_if_t<is_range<R>::value && !::Catch::Detail::IsStreamInsertable_v<R>>> {
