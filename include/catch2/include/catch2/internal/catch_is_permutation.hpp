...
namespace Catch {
    namespace Detail {
        ...
        find_sentinel(ForwardIter start, Sentinel sentinel, T const& value, Comparator cmp) {
        ...
        count_sentinel(ForwardIter start, Sentinel sentinel, T const& value, Comparator cmp) {
        ...
        template <
            ...
            typename Sentinel2,
            typename Comparator>
        constexpr bool check_element_counts(
            ForwardIter1 first_1,
