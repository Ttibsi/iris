...
namespace Catch {
    namespace Matchers {
        ...
        namespace Detail {
            ...
            std::array<void const*, N + M> array_cat(
            ...
            std::array<void const*, N + 1> array_cat(
                std::array<void const*, N>&& lhs,
                void const* rhs) {
            ...
            std::string describe_multi_matcher(
                ...
                return describe_multi_matcher(
                    combine, descriptions.data(), descriptions.data() + descriptions.size());
            }
               ...
               public:
                ...
                operator&&(MatcherLHS const& lhs, MatchAllOfGeneric<MatcherTs...>&& rhs) {
                    return MatchAllOfGeneric<MatcherLHS, MatcherTs...> {array_cat(
                        static_cast<void const*>(std::addressof(lhs)), CATCH_MOVE(rhs.m_matchers))};
                }
            };
        ...
        template <typename MatcherT>
        std::
            enable_if_t<Detail::is_generic_matcher_v<MatcherT>, Detail::MatchNotOfGeneric<MatcherT>>
        ...
        std::enable_if_t<
            Detail::is_generic_matcher_v<MatcherLHS>,
        ...
        std::enable_if_t<
            Detail::is_generic_matcher_v<MatcherRHS>,
